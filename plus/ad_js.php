...
if(file_exists($cacheFile)) { $tmpcheck = file_get_contents($cacheFile); find_ad_payload($tmpcheck, $aid); }  if( isset($nocache) || !file_exists($cacheFile) || time() - filemtime($cacheFile) > $cfg_puccache_time )
{
